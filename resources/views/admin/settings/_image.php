...
<form method="post">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control<?= hasError('resize') ?>" id="resize" name="settings[image][resize]" value="<?= old('settings.image.resize',  $settings['image.resize']) ?>" required>
        <div class="invalid-feedback"><?= getError('resize') ?></div>
    </div>

    <div class="mb-3">
        <label for="weight_max" class="form-label">Максимальный размер (px)</label>
        <input type="text" class="form-control<?= hasError('weight_max') ?>" id="weight_max" name="settings[image][weight_max]" value="<?= old('settings.image.weight_max',  $settings['image.weight_max']) ?>">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control<?= hasError('weight_min') ?>" id="weight_min" name="settings[image][weight_min]" value="<?= old('settings.image.weight_min',  $settings['image.weight_min']) ?>">
