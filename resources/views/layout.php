...
<header class="py-3 mb-3 border-bottom" style="background-color: #9156f8">
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            <a href="/" class="d-flex align-items-center mb-2 mb-lg-0 text-dark text-decoration-none">
                ...
                <span class="fs-4 text-light">Motor CMS</span>
            </a>

           <!-- <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                <li><a href="/guestbook" class="nav-link px-2 link-secondary">Гостевая</a></li>
            </ul>-->

            <form class="col-12 col-lg-auto mb-3 mb-lg-0 ms-lg-auto me-lg-3" action="/search" method="get"  role="search">
                <input type="search" name="search" class="form-control" placeholder="Поиск..." aria-label="Search" required>
            </form>
...
<div class="app col-lg-10 mx-auto p-3 py-md-4">
    <main>
