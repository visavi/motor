...
<form method="post">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control<?= hasError('size_max') ?>" id="size_max" name="settings[file][size_max]" value="<?= old('settings.file.size_max',  round($settings['file.size_max'] / 1048576)) ?>" required>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control<?= hasError('total_max') ?>" id="total_max" name="settings[file][total_max]" value="<?= old('settings.file.total_max',  $settings['file.total_max']) ?>" required>
