...
<div class="row justify-content-center py-4">
    <div class="col-lg-8 text-center">
        ...
        <?php if ($release): ?>
            <a href="/docs/versions" class="btn btn-sm btn-outline-primary mb-4">
                <i class="bi bi-stars me-1"></i>
                Новое в <?= escape($release['tag_name']) ?>
            </a>
        <?php endif; ?>

        <svg width="140" height="140" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="text-primary mb-3" aria-hidden="true">
        ...
        <h1 class="display-6 fw-bold mb-3">Создайте свой первый сайт</h1>

        <p class="fs-4 text-secondary mb-4">
            Лёгкий и быстрый движок для сайта. Не использует базу данных, не требует особых
            библиотек на сервере. Работает абсолютно на всех бесплатных хостингах
        </p>

        <div class="row g-2 justify-content-center align-items-center mb-4">
            <div class="col-auto">
                <code class="d-block px-3 py-2 border rounded bg-surface-secondary">composer create-project visavi/motor .</code>
            </div>
            <div class="col-auto">
        ...
        <p class="text-secondary mb-0">
            <?php if ($release): ?>
                Версия <strong><?= escape($release['tag_name']) ?></strong>
