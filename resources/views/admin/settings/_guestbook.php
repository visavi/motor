...
<form method="post">
    ...
    <div class="mb-3">
        ...
        <input type="number" class="form-control<?= hasError('text_min_length') ?>" id="text_min_length" name="settings[guestbook][text_min_length]" value="<?= old('settings.guestbook.text_min_length',  $settings['guestbook.text_min_length']) ?>" required>
    ...
    <div class="mb-3">
        ...
        <input type="number" class="form-control<?= hasError('text_max_length') ?>" id="text_max_length" name="settings[guestbook][text_max_length]" value="<?= old('settings.guestbook.text_max_length',  $settings['guestbook.text_max_length']) ?>" required>
    ...
    <div class="mb-3">
        ...
        <input type="number" class="form-control<?= hasError('name_min_length') ?>" id="name_min_length" name="settings[guestbook][name_min_length]" value="<?= old('settings.guestbook.name_min_length',  $settings['guestbook.name_min_length']) ?>" required>
    ...
    <div class="mb-3">
        ...
        <input type="number" class="form-control<?= hasError('name_max_length') ?>" id="name_max_length" name="settings[guestbook][name_max_length]" value="<?= old('settings.guestbook.name_max_length',  $settings['guestbook.name_max_length']) ?>" required>
